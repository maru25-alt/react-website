export const terms = {
  ...
  descriptions: [
    ...
    "The use of the Website is available only for the residents on the USA of legal age. By continuous use of the Website You confirm that You are at least 18 years old and reside in the US. The services provided on the Website are not available for the residents of some states, including, but not limited to Arkansas, New York, West Virginia and Vermont due to specific regulations regarding online personal lending in these locations. The list of states is subject to changes. Please, check the status of Your state on Rates and Fees, which contain the recent and up to date information regarding online personal lending in the USA.",
  ...
  informations: [
    {
      ...
      contents: [
        "As mentioned above the Company is not a lender and does not make credit decisions, rather connects its Users with independent third party lenders, who can provide the Users with personal loans of up to $3,000 (the amount of available loans depend on the regulations in each state). Since the Company has nothing to do with the credit decisions third party lenders make, the decision to approve Your request, as well as the amount and terms of the offered loan products are exclusively made by loan providers and depend in each individual case on many factors. The Company cannot guarantee that Your attempt to be matched with a lender will result in the approval of Your request, or that You will be offered the desired amount on the desired terms. Not all the lenders in our network can provide loans of up to $3,000.",
        "We encourage every User of the Website who has doubts about any particular loan offer or online personal lending in general to seek professional consult and support, as this form or lending is a relatively expensive form of credit and remains effective only if used for reasonably. Keep in mind, that the Company has nothing to do with the terms of any particular loan offer or credit product, thus, takes no responsibilities for the decisions third parties make and cannot provide information regarding any particular credit operation.",
    ...
    {
      title: "Authorized Use and Proprietary Rights",
      contents: [
    ...
    {
      title: "Implication of Privacy Policy in Marketing Activity",
      contents: [
    ...
    {
      title: "Severability and Termination",
      contents: [
    ...
    },
    {
      ...
      contents: [
        "In case You have a request, complaint or enquiry regarding the services provided by the Website, You can contact us via this email help@gotloaned.com In case You consider Your issue treated improperly, You can also contact the corresponding organizations in Your state of residence authorized to review or resolve the cases of the kind.",
